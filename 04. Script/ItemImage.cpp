...
void ItemImage::Init(CItemScript * item)
{
	...
	Vector3 itemScale = item->Object()->Transform()->GetLocalScale();
	itemScale.x = 100.f;
	itemScale.y = 100.f;
	...
	Vector3 rotateObjectScale = item->Object()->GetParent()->Transform()->GetLocalScale();
	Vector3 playerObjectScale = item->Object()->GetParent()->GetParent()->Transform()->GetLocalScale();
	...
	Vector3 playerObjectPosition = item->Object()->GetParent()->GetParent()->Transform()->GetLocalPos();

	Vector3 itemPosition = Vector3(0.f, 15.f, -0.1f);
